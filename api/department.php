...
<body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body" hidden>
                                    <table id="dataTable" class="table table-bordered table-striped">
                                        ...
                                        <tbody id="departmentList" align="center"></tbody>
                                    </table>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="Add_Dep" class="form-control" placeholder="Enter a department" onKeyUp="addCheck(this)">
                                                    <span id="Add_Dep_error" name="error_text" style="color:red;font-size:small"></span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div id="Edit_Inputs">
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="form-group">
                                                    <label>Department</label>
                                                    <input type="text" id="Edit_Dep" class="form-control" placeholder="Enter a department" onKeyUp="editCheck(this)">
                                                    <span id="Edit_Dep_error" name="error_text" style="color:red;font-size:small"></span>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-lg-6">
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-3">
                                                        <input id="Edit_Dep_IsActive" type="checkbox" class="form-control">
                                                    </div>
                                                    <div class="col-lg-9"></div>
                                                </div>
                                            </div>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content callout callout-danger">
                            ...
                            <form id="deleteForm" hidden>
                                <div class="modal-body">
                                    <input id="Delete_Dep_Id" type="hidden">
    ...
    <script>
        ...
        function addBtn() {
            ...
            var department = document.getElementById("Add_Dep").value;

            var Status_Department = false;

            if (department.trim() != '') {
                Status_Department = false;
                $("#Add_Dep").removeClass("is-invalid");
                text = document.getElementById("Add_Dep_error");
                text.textContent = "";
            } else {
                Status_Department = true;
                $("#Add_Dep").addClass("is-invalid");
                var text = document.getElementById("Add_Dep_error");
                text.textContent = "Enter a department";
            }

            if (Status_Department == true) {
                return;
            } else {
                ...
                $.ajax({
                    ...
                    success: function(html) {
                        ...
                        window.setTimeout("location.href='department.php'", 1000);
                    },
                    dataType: "json"
                });
            }
        ...
        function editRow(row) {
            ...
            $.ajax({
                ...
                success: function(html) {
                    ...
                    $('#Edit_Dep').val(html.department.Dep_Desc);

                    if (html.department.Dep_IsActive == 1) {
                        $("#Edit_Dep_IsActive").prop("checked", "checked");
                    } else {
                        $("#Edit_Dep_IsActive").removeAttr("checked");
                    }
        ...
        function editBtn() {
            ...
            var Dep_Desc = document.getElementById("Edit_Dep").value;
            var status = $('#Edit_Dep_IsActive:checked').val();
            var Status_Dep_Desc = false;

            if (Dep_Desc.trim() != '') {
                Status_Dep_Desc = false;
                $("#Edit_Dep").removeClass("is-invalid");
                text = document.getElementById("Edit_Dep_error");
                text.textContent = "";
                
            } else {
                Status_Dep_Desc = true;
                $("#Edit_Dep").addClass("is-invalid");
                var text = document.getElementById("Edit_Dep_error");
                text.textContent = "Enter a department";
            }

            if (Status_Dep_Desc == true) {
                return;
            } else {
            ...
            $.ajax({
                ...
                success: function(html) {
                    if (html.success == false) {
                        ...
                        depName = html.department;
                        $('#Delete_Dep_Id').val(Dep_Id);
                        var text = document.getElementById("text");
                        text.textContent = "Are you sure you want to delete " + depName + "?";
                        $('.delete-modal-loader').attr("hidden", true);
                        $('#deleteForm').removeAttr("hidden");
        ...
        function deleteBtn() {
            ...
            var Dep_Id = document.getElementById("Delete_Dep_Id").value;
            $.ajax({
                type: 'POST',
                url: 'departmentProcessor.php',
                data: {
        ...
        $(function() {
            ...
            $.ajax({
                ...
                success: function(html) {
                    $('#departmentList').html(html.departmentList);
